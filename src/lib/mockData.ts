...
// 4. Default SaaS University Scholars Pool (Real-looking SaaS Community)
export const DEFAULT_SCHOLARS: UserDirectoryEntry[] = [
  {
    id: 'sch_1',
    name: 'Aarav Sharma',
    username: 'aarav_ai',
  ...
  },
  {
    ...
    name: 'Kabir Singh',
    username: 'kabir_dev',
    email: 'kabir.singh@dtu.ac.in',
    avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=250&q=80',
    collegeName: 'DTU Delhi',
    course: 'B.Tech Software Eng.',
    department: 'Computer Science',
    xp: 920,
    level: 'AI Apprentice',
    streak: 4,
