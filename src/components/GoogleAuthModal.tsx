...
export const GoogleAuthModal: React.FC<GoogleAuthModalProps> = ({ isOpen, onClose }) => {
  ...
  const [subjectsStr, setSubjectsStr] = useState('Operating Systems, DBMS, DSA');
  ...
  const labelStyle: React.CSSProperties = {
    ...
    color: '#94a3b8', marginBottom: '3px', textTransform: 'uppercase', letterSpacing: '0.4px',
  ...
  return (
    ...
    >
      {/* Centered Floating Window - NO SCROLLING */}
      <div
        style={{
          ...
          boxShadow: '0 30px 70px rgba(0, 0, 0, 0.9), 0 0 50px rgba(0, 240, 255, 0.2)',
          position: 'relative',
          overflow: 'hidden',
        }}
      >
        ...
        <div style={{ padding: '22px 22px 10px', textAlign: 'center' }}>
          <div style={{
            ...
            <svg viewBox="0 0 24 24" fill="none" width="20" height="20" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <path d="M12 2L2 7l10 5 10-5-10-5z"/><path d="M2 17l10 5 10-5"/><path d="M2 12l10 5 10-5"/>
            </svg>
          </div>
          <h2 style={{ fontSize: 17, fontWeight: 700, color: '#fff', margin: 0, fontFamily: "'Inter', system-ui, sans-serif" }}>
            {screen === 'onboarding' ? 'Academic Profile Setup' : screen === 'email-register' ? 'Create Account' : 'Sign In to Subjective Test AI'}
          </h2>
          <p style={{ fontSize: 12, color: '#94a3b8', margin: '3px 0 0', fontFamily: "'Inter', system-ui, sans-serif" }}>
            {screen === 'onboarding' ? 'Configure university details for test builder' : 'Real SaaS Account Portal'}
          </p>
        </div>
        ...
        <div style={{ padding: '10px 22px 20px' }}>
          ...
          {error && (
            <div style={{
              ...
              color: '#fca5a5', fontSize: 11, fontFamily: "'Inter', system-ui, sans-serif",
          ...
          {(loading || redirecting) ? (
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '28px 0', gap: 10 }}>
              ...
              <p style={{ fontSize: 12, color: '#00f0ff', fontWeight: 600, fontFamily: "'Inter', system-ui, sans-serif" }}>
                {redirecting ? 'Redirecting to Google...' : 'Connecting to Firebase Auth...'}
              </p>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '2px 0' }}>
                ...
                <span style={{ fontSize: 10, color: '#64748b', textTransform: 'uppercase', letterSpacing: 1, fontFamily: "'Inter', system-ui, sans-serif" }}>or</span>
                <div style={{ flex: 1, height: 1, backgroundColor: 'rgba(255,255,255,0.1)' }} />
              </div>
              ...
              <button
                ...
                style={{
                  ...
                  backgroundColor: 'rgba(255,255,255,0.04)', color: '#cbd5e1',
                  border: '1px solid rgba(255,255,255,0.12)',
              ...
              <div style={{ textAlign: 'center', paddingTop: 2 }}>
                <button
                  ...
                  style={{ background: 'none', border: 'none', color: '#00f0ff', fontSize: 12, fontWeight: 500, cursor: 'pointer', fontFamily: "'Inter', system-ui, sans-serif" }}
                >
            ...
            <form onSubmit={handleEmailSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 9 }}>
              ...
              <button type="submit" style={{ ...primaryBtnStyle, marginTop: 3 }}>
              ...
              <div style={{ textAlign: 'center', paddingTop: 2 }}>
                <button
                  ...
                  style={{ background: 'none', border: 'none', color: '#00f0ff', fontSize: 12, cursor: 'pointer', fontFamily: "'Inter', system-ui, sans-serif" }}
                >
              ...
              <div style={{ textAlign: 'center' }}>
                <button
                  ...
                  style={{ background: 'none', border: 'none', color: '#64748b', fontSize: 11, cursor: 'pointer', fontFamily: "'Inter', system-ui, sans-serif" }}
                >
            ...
            /* ─── Onboarding Form (2-column compact grid, NO scrolling) ─── */
            <form onSubmit={handleOnboarding} style={{ display: 'flex', flexDirection: 'column', gap: 9 }}>
              <div style={{
                padding: '6px 10px', borderRadius: 6,
                backgroundColor: 'rgba(0,240,255,0.08)', border: '1px solid rgba(0,240,255,0.2)',
                color: '#00f0ff', fontSize: 11, fontWeight: 600, fontFamily: "'Inter', system-ui, sans-serif",
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
                ...
                <div>
                  <label style={labelStyle}>Subjects (comma sep)</label>
        ...
        <div style={{
          ...
          fontSize: 10, color: '#475569', fontFamily: "'Inter', system-ui, sans-serif",
